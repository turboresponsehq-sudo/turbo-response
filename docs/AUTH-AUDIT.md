...
4. All admin API calls include `Authorization: Bearer REDACTED_RETIRED_BEARER_TOKEN` header
...
- Component makes API call with `Authorization: Bearer REDACTED_RETIRED_BEARER_TOKEN`
- Backend returns 401
...
2. Remove `Authorization: Bearer REDACTED_RETIRED_BEARER_TOKEN` headers
