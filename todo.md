...
- [ ] Remove Authorization: Bearer REDACTED_RETIRED_BEARER_TOKEN headers from AdminDashboard.tsx
...
- [ ] Remove all Authorization: Bearer REDACTED_RETIRED_BEARER_TOKEN
