...
function HomeTab({ onNavigate }: { onNavigate: (tab: Tab) => void }) {
  ...
  return <div>
    ...
    {hasDataAccessError && <section style={{ ...styles.card, borderColor: '#f59e0b66' }}><h2 style={{ ...styles.sectionTitle, color: '#fbbf24' }}>Some operator data is unavailable</h2><p style={{ color: '#cbd5e1', margin: 0 }}>The Command Center remains available. Your previous admin session was invalidated by the security credential rotation. <a href="/admin/login?next=/admin/command-center" style={{ color: '#67e8f9' }}>Refresh admin session</a> to sign in and return here.</p></section>}
