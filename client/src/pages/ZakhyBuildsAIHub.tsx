...
import AtlantaChapterOne from "../zakhy/pages/AtlantaChapterOne";
...
export function ZakhyProjectRoute({ sourcePath }: { sourcePath: string }) {
  switch (sourcePath) {
    ...
    case "/atlanta": return <AtlantaChapterOne />;
    case "/atlanta/neighborhoods": return <AtlantaChapterOne />;
    case "/atlanta/media": return <AtlantaChapterOne />;
