  ...
  return (
    <main className="ralo-page">
      <header className="ralo-header" id="home">
        <a className="ralo-logo" href="/zakhybuildsai/portfolio/ralo" aria-label="Famgoon website home"><img src="https://zakhydemo-mpd8k29q.manus.space/manus-storage/famgoon-header-logo-tight_138459fd.png" alt="FAMGOON" /></a>
