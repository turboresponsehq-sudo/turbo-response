...
<head>
  <style>
    ...
    .header { background: linear-gradient(135deg, #4285F4 0%, #3b82f6 100%); color: #0A1A3F; padding: 30px; text-align: center; border-radius: 10px 10px 0 0; }
    .section { background: #f8f9fa; padding: 20px; margin: 20px 0; border-left: 4px solid #4285F4; }
    .section-title { font-size: 14px; font-weight: bold; color: #4285F4; text-transform: uppercase; margin-bottom: 10px; }
    .field { margin: 10px 0; }
    ...
    .record-id { background: #4285F4; color: #0A1A3F; padding: 4px 12px; border-radius: 20px; font-size: 13px; display: inline-block; margin-top: 8px; }
  </style>
</head>
<body>
  <div class="container">
