        ...
        <div style="margin-top: 30px; padding: 20px; background-color: #d4edda; border-radius: 8px;">
          ...
          <p style="margin: 10px 0 0 0;">
            <a href="https://turboresponsehq.ai/admin" 
               style="display: inline-block; padding: 12px 24px; background-color: #007bff; color: #0A1A3F; text-decoration: none; border-radius: 6px;">
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="margin-top: 30px; padding: 20px; background-color: #fff3cd; border-radius: 8px;">
          ...
          <p style="margin: 10px 0 0 0;">
            <a href="https://turboresponsehq.ai/admin" 
               style="display: inline-block; padding: 12px 24px; background-color: #28a745; color: #0A1A3F; text-decoration: none; border-radius: 6px;">
              Verify Payment
            </a>
          </p>
        </div>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #f8fafc; padding: 30px; border-radius: 0 0 8px 8px;">
          ...
          <div style="background-color: #0A1A3F; padding: 20px; border-radius: 8px; margin: 20px 0;">
