    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #f8fafc; padding: 30px; border-radius: 0 0 8px 8px;">
          ...
          <div style="background-color: white; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #1A3FC7;">
          ...
          <div style="background-color: #dbeafe; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <a href="https://turboresponsehq.ai/client/login" 
               style="display: inline-block; padding: 14px 28px; background: linear-gradient(135deg, #1A3FC7, #0284c7); color: white; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #f8fafc; padding: 30px; border-radius: 0 0 8px 8px;">
          ...
          <div style="background-color: #dbeafe; padding: 20px; border-radius: 8px; margin: 20px 0; text-align: center;">
            ...
            <a href="https://turboresponsehq.ai/client/login" 
               style="display: inline-block; padding: 15px 30px; background-color: #1A3FC7; color: white; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px;">
